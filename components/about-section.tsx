      ...
      <div className="max-w-6xl mx-auto glass-effect rounded-3xl p-8 md:p-12 hover:shadow-2xl transition-all duration-500">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto text-pretty">
            Green Studio is a Marketing & Media Production Agency born from the energy of a new generation.
            Founded in April 2025 in Giza, Egypt, we’ve grown into a 15-member creative force blending Marketing,
            Branding, Videography, and AI innovation.
            We don’t just deliver campaigns — we build movements.
            Our mission is to empower e-commerce and emerging brands across Egypt, the Gulf, and
            Dubai with creative strategies that actually drive growth, not just likes.
            Every project we touch is powered by strategy, creativity, and that extra spark — the one
            that keeps us up at 2 AM because we love what we do
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 text-center">
          <Card className="animate-card opacity-0 glass-effect border-primary/20 hover:scale-105 hover:rotate-1 transition-all duration-300">
            <CardContent className="p-8">
              <div className="flex items-center mb-4">
                <Target className="h-8 w-8 mr-3 animate-spin" style={{ color: '#f59e0b' }} />
                <h3 className="text-2xl font-bold">Our Vision</h3>
              </div>
              <p className="text-muted-foreground text-pretty">
                To become the leading creative-tech
                studio in the Middle East —
                a place where bold ideas meet intelligent
                execution.
                We see a future where brands grow
                sustainably through strategy, automation,
                and storytelling that connects.
                Our future is built on one thing: limitless
                imagination backed by real results
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="animate-card opacity-0 glass-effect border-accent/20 hover:scale-105 hover:-rotate-1 transition-all duration-300">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground text-pretty">
                To revolutionize how brands grow in the
                digital era —
                by merging creativity, technology, and
                data into one seamless experience that
                moves people and markets.
                We believe in marketing that feels human,
                design that inspires action, and
                automation that frees creativity
              </p>
            </CardContent>
          </Card>
        </div>
